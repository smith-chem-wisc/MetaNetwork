...
ui <- shinyUI(navbarPage("WGCNA and GO analysis",
                         ...
                         tabPanel("Step 1: WGCNA Analysis",
                                  ...
                                  sidebarPanel(
                                    ...
                                    fileInput(inputId = "dataFile",
                                              label = "Data (.csv file) See note for required formatting."),
                                    fileInput(inputId = "groupsFile",
                                              label = "Groups (.csv file) See note for required formatting."),
                                    fileInput(inputId = "databaseFile",
                                              label = "Enter Database File Downloaded from Uniprot"),
                                    # WGCNA Workflow parameters ----
                                    h3("WGCNA workflow parameters"),
                                    ...
                                    textInput(inputId = "threads",
                                              label = "Enter how many threads to use",
                                              value = ""),
                         ...
                         tabPanel("Step 2: GO Enrichment Analysis",
                                  sidebarPanel(
                                    fileInput(inputId = "WGCNAResults",
                                              label = "Import WGCNA results worksheet", ),
